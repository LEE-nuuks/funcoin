...
uint256 hashGenesisBlock("0x6caeea40817b1dfce2e8849f829a09572b9d86083bc52513b06787ff59068574");
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x41f074c55c7c70bac486f0466f505364d6b4a637421e9d073badafc4f5b9abf8");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Dough Jones defeats Roy More in Albama senate election";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1661200044;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2085342202;

        if (fTestNet)
        {
            block.nTime    = 1661200020;
            block.nNonce   = 385337537;
        }
...
if (false && block.GetHash() != hashGenesisBlock)
        ...
        assert(block.hashMerkleRoot == uint256("0xd9adc48f3b61912c0441506442498b0e9367eaeeda2dd04af49d15c555dffdf1"));
        block.print();
